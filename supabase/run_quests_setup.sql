-- ============================================================================
-- Quests System - Combined Migration and Seed
-- Run this file in Supabase SQL Editor to set up the Quests system
-- ============================================================================
...
DROP POLICY IF EXISTS "Auth start quest" ON quest_progress;
DROP POLICY IF EXISTS "User reads own progress" ON quest_progress;
DROP POLICY IF EXISTS "User updates own progress" ON quest_progress;
DROP POLICY IF EXISTS "Verifier reads all submissions" ON quest_progress;
DROP POLICY IF EXISTS "Verifier can verify" ON quest_progress;
DROP POLICY IF EXISTS "Read own badges" ON user_badges;
DROP POLICY IF EXISTS "Award badges" ON user_badges;
...
-- Clear existing data (for development - comment out in production)
...
-- Create a public bucket called 'quest-photos'
-- ============================================================================

-- To make a user a verifier, run:
-- UPDATE profiles SET is_verifier = true WHERE id = 'your-profile-id';

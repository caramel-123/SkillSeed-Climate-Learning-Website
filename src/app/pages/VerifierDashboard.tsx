...
import { Loader2, ClipboardList, Users, Crown } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-8 py-10">
        ...
        {activeTab === 'admins' && profile?.is_super_admin && (
          <AdminManagement currentProfileId={profile.id} />
        )}
            ...
            {submissions.length === 0 ? (
              ...
              <div className="flex flex-col gap-6">
                {submissions.map(sub => {
                  ...
                  return (
                    <div key={sub.id} className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
                      ...
                      {sub.photo_url && (
                        <div className="mb-5">
                          <p className="text-xs font-medium text-gray-500 mb-2">Proof Photo</p>
                          <img
                            src={sub.photo_url}
                      ...
                      {/* Reflection */}
                      <div className="mb-5">
                        <p className="text-xs font-medium text-gray-500 mb-2">Reflection</p>
